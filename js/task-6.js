...
//объявить переменные для ввода и суммирования чисел
let input = "";
let total = 0;

//запустить цикл при котором пользователь вводит числа и они ссумируются до тех пор пока пользователь не нажмет отмена +++ проверка на число
do {
...
//вывести полученную сумму от пользователя в alert
