...
// узнать у пользователя, сколько он хочет дроидов и сохранить ответ в переменную. Создать переменную для общей суммы заказа
const orderedQuantity = prompt("Сколько дроидов Вы хотите заказать?");
const totalPrice = Number(orderedQuantity) * pricePerDroid;

// Подобрать сообщения для вывода в зависимости от того, что ввел пользователь
